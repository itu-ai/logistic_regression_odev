...
- **Gradient Descent :** Modelin ağırlıklarını güncellemek için kullanılan optimizasyon yöntemidir. Kayıp fonksiyonunun gradyanı hesaplanarak ağırlıklar her adımda küçük bir öğrenme oranı ($\alpha$) ile güncellenir.
- **Learning Rate :** Gradient descent'te ağırlıkların her adımda ne kadar güncelleneceğini belirleyen hiperparametredir. Farklı değerlerle deneyip etkisini gözlemleyin.
